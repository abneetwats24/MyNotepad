...
namespace MyNotepad {
    public partial class FindDialog : Form {
        private readonly MyNotepad _Main;

        public FindDialog(MyNotepad pMain) {
            InitializeComponent();
            _Main = pMain;
        }
        ...
        private void buttonFindNext_Click(object sender, EventArgs e) {
            ...
            if (!_Main.FindAndSelect(SearchText, MatchCase, bSearchDown)) {
                MessageBox.Show(this, CONST.CannotFindMessage.FormatUsingObject(new { SearchText = SearchText }), "MyNotepad");
            }
        }
